...
// OData-Query
#define COCOAPODS_POD_AVAILABLE_OData_Query
#define COCOAPODS_VERSION_MAJOR_OData_Query 0
#define COCOAPODS_VERSION_MINOR_OData_Query 1
#define COCOAPODS_VERSION_PATCH_OData_Query 0
